...
},{"../asn1":1,"inherits":119,"vm":196}],3:[function(require,module,exports){
...
},{"../base":4,"buffer":53,"inherits":119}],4:[function(require,module,exports){
...
},{"./der":9,"buffer":53,"inherits":119}],12:[function(require,module,exports){
...
},{"../../asn1":1,"buffer":53,"inherits":119}],13:[function(require,module,exports){
...
},{"util/":193}],16:[function(require,module,exports){
...
},{"safe-buffer":170}],19:[function(require,module,exports){
...
},{"safe-buffer":170}],23:[function(require,module,exports){
...
},{"./aes":22,"./ghash":27,"./incr32":28,"buffer-xor":52,"cipher-base":54,"inherits":119,"safe-buffer":170}],24:[function(require,module,exports){
...
},{"./aes":22,"./authCipher":23,"./modes":35,"./streamCipher":38,"cipher-base":54,"evp_bytestokey":101,"inherits":119,"safe-buffer":170}],26:[function(require,module,exports){
...
},{"./aes":22,"./authCipher":23,"./modes":35,"./streamCipher":38,"cipher-base":54,"evp_bytestokey":101,"inherits":119,"safe-buffer":170}],27:[function(require,module,exports){
...
},{"safe-buffer":170}],28:[function(require,module,exports){
...
},{"buffer-xor":52,"safe-buffer":170}],31:[function(require,module,exports){
...
},{"safe-buffer":170}],32:[function(require,module,exports){
(function (Buffer){
...
},{"./aes":22,"cipher-base":54,"inherits":119,"safe-buffer":170}],39:[function(require,module,exports){
...
},{"browserify-aes/browser":24,"browserify-aes/modes":35,"browserify-des":40,"browserify-des/modes":41,"evp_bytestokey":101}],40:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":53,"cipher-base":54,"des.js":66,"inherits":119}],41:[function(require,module,exports){
...
},{"bn.js":19,"buffer":53,"randombytes":154}],43:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":53,"js-sha3":123}],44:[function(require,module,exports){
...
},{"./algorithms.json":45,"./sign":48,"./verify":49,"buffer":53,"create-hash":60,"inherits":119,"stream":187}],48:[function(require,module,exports){
(function (Buffer){
...
},{"./curves.json":46,"bn.js":19,"browserify-rsa":42,"buffer":53,"create-hmac":63,"elliptic":76,"parse-asn1":140}],49:[function(require,module,exports){
(function (Buffer){
...
},{"./curves.json":46,"bn.js":19,"buffer":53,"elliptic":76,"parse-asn1":140}],50:[function(require,module,exports){
...
},{"bs58":50,"buffer":53,"create-hash":60}],52:[function(require,module,exports){
(function (Buffer){
...
},{"base64-js":17,"ieee754":117}],54:[function(require,module,exports){
...
},{"inherits":119,"safe-buffer":170,"stream":187,"string_decoder":188}],55:[function(require,module,exports){
(function (Buffer){
function encode(e,r){(Array.isArray(e)||e instanceof Uint8Array)&&(e=new Buffer(e));var n;null!=r?("number"==typeof r&&(r=new Buffer([r])),n=Buffer.concat([r,e])):n=e;var t=sha256x2(n).slice(0,4),c=Buffer.concat([n,t]);return base58.encode(c)}function decode(e,r){var n,t=base58.decode(e),c=new Buffer(t);if(null==r)n=0;else if("number"==typeof r&&(r=new Buffer([r])),n=r.length,c.slice(0,n).toString("hex")!==r.toString("hex"))throw new Error("Invalid version");var a=c.slice(-4),o=c.length-4,i=c.slice(0,o),d=sha256x2(i).slice(0,4);if(a.toString("hex")!==d.toString("hex"))throw new Error("Invalid checksum");return i.slice(n)}function isValid(e,r){try{decode(e,r)}catch(e){return!1}return!0}function createEncoder(e){return function(r){return encode(r,e)}}function createDecoder(e){return function(r){return decode(r,e)}}function createValidator(e){return function(r){return isValid(r,e)}}function sha256x2(e){var r=createHash("sha256").update(e).digest();return createHash("sha256").update(r).digest()}var base58=require("bs58"),createHash=require("create-hash");module.exports={encode:encode,decode:decode,isValid:isValid,createEncoder:createEncoder,createDecoder:createDecoder,createValidator:createValidator};

}).call(this,require("buffer").Buffer)
},{"bs58":56,"buffer":53,"create-hash":60}],56:[function(require,module,exports){
function encode(r){if(0===r.length)return"";var e,A=[0];for(t=0;t<r.length;t++){for(e=0;e<A.length;e++)A[e]<<=8;A[0]+=r[t];var n=0;for(e=0;e<A.length;++e)A[e]+=n,n=A[e]/BASE|0,A[e]%=BASE;for(;n;)A.push(n%BASE),n=n/BASE|0}for(t=0;0===r[t]&&t<r.length-1;t++)A.push(0);for(var o="",t=A.length-1;t>=0;t--)o+=ALPHABET[A[t]];return o}function decode(r){if(0===r.length)return[];var e,A,n=[0];for(e=0;e<r.length;e++){var o=r[e];if(!(o in ALPHABET_MAP))throw new Error("Non-base58 character");for(A=0;A<n.length;A++)n[A]*=BASE;n[0]+=ALPHABET_MAP[o];var t=0;for(A=0;A<n.length;++A)n[A]+=t,t=n[A]>>8,n[A]&=255;for(;t;)n.push(255&t),t>>=8}for(e=0;"1"===r[e]&&e<r.length-1;e++)n.push(0);return n.reverse()}for(var ALPHABET="123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz",ALPHABET_MAP={},i=0;i<ALPHABET.length;i++)ALPHABET_MAP[ALPHABET.charAt(i)]=i;var BASE=58;module.exports={encode:encode,decode:decode};
...
},{"../../is-buffer/index.js":120}],59:[function(require,module,exports){
(function (Buffer){
...
},{"bn.js":19,"buffer":53,"elliptic":76}],60:[function(require,module,exports){
(function (Buffer){
...
},{"./md5":62,"buffer":53,"cipher-base":54,"inherits":119,"ripemd160":168,"sha.js":180}],61:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":53}],62:[function(require,module,exports){
...
},{"./legacy":64,"cipher-base":54,"create-hash/md5":62,"inherits":119,"ripemd160":168,"safe-buffer":170,"sha.js":180}],64:[function(require,module,exports){
...
},{"cipher-base":54,"inherits":119,"safe-buffer":170}],65:[function(require,module,exports){
...
},{"browserify-cipher":39,"browserify-sign":47,"browserify-sign/algos":44,"create-ecdh":59,"create-hash":60,"create-hmac":63,"diffie-hellman":72,"pbkdf2":141,"public-encrypt":148,"randombytes":154}],66:[function(require,module,exports){
...
},{"inherits":119,"minimalistic-assert":134}],68:[function(require,module,exports){
...
},{"minimalistic-assert":134}],69:[function(require,module,exports){
...
},{"../des":66,"inherits":119,"minimalistic-assert":134}],70:[function(require,module,exports){
...
},{"../des":66,"inherits":119,"minimalistic-assert":134}],71:[function(require,module,exports){
...
},{"./lib/dh":73,"./lib/generatePrime":74,"./lib/primes.json":75,"buffer":53}],73:[function(require,module,exports){
(function (Buffer){
...
},{"./generatePrime":74,"bn.js":19,"buffer":53,"miller-rabin":133,"randombytes":154}],74:[function(require,module,exports){
...
},{"bn.js":19,"miller-rabin":133,"randombytes":154}],75:[function(require,module,exports){
module.exports={
    "modp1": {
        "gen": "02",
...
},{"../package.json":91,"./elliptic/curve":79,"./elliptic/curves":82,"./elliptic/ec":83,"./elliptic/eddsa":86,"./elliptic/utils":90,"brorand":20}],77:[function(require,module,exports){
...
},{"../../elliptic":76,"bn.js":19}],78:[function(require,module,exports){
...
},{"../../elliptic":76,"../curve":79,"bn.js":19,"inherits":119}],79:[function(require,module,exports){
...
},{"../../elliptic":76,"../curve":79,"bn.js":19,"inherits":119}],81:[function(require,module,exports){
...
},{"../../elliptic":76,"../curve":79,"bn.js":19,"inherits":119}],82:[function(require,module,exports){
...
},{"../elliptic":76,"./precomputed/secp256k1":89,"hash.js":103}],83:[function(require,module,exports){
...
},{"../../elliptic":76,"./key":84,"./signature":85,"bn.js":19,"hmac-drbg":116}],84:[function(require,module,exports){
...
},{"../../elliptic":76,"bn.js":19}],85:[function(require,module,exports){
...
},{"../../elliptic":76,"bn.js":19}],86:[function(require,module,exports){
...
},{"../../elliptic":76,"./key":87,"./signature":88,"hash.js":103}],87:[function(require,module,exports){
...
},{"../../elliptic":76,"bn.js":19}],89:[function(require,module,exports){
...
},{"bn.js":19,"minimalistic-assert":134,"minimalistic-crypto-utils":135}],91:[function(require,module,exports){
module.exports={
  "_args": [
    [
      "elliptic@6.4.0",
...
},{"buffer":53,"ethereum-common/params.json":92,"ethereumjs-util":95}],95:[function(require,module,exports){
(function (Buffer){
...
},{"assert":15,"bn.js":19,"buffer":53,"create-hash":60,"ethjs-util":99,"keccak":124,"rlp":169,"secp256k1":173}],96:[function(require,module,exports){
(function (Buffer){
...
},{"assert":15,"bn.js":19,"buffer":53,"create-hash":60,"keccakjs":130,"rlp":169,"secp256k1":173}],97:[function(require,module,exports){
function EthereumHDKey(){}function fromHDKey(e){var t=new EthereumHDKey;return t._hdkey=e,t}const HDKey=require("hdkey"),Wallet=require("./index.js");EthereumHDKey.fromMasterSeed=function(e){return fromHDKey(HDKey.fromMasterSeed(e))},EthereumHDKey.fromExtendedKey=function(e){return fromHDKey(HDKey.fromExtendedKey(e))},EthereumHDKey.prototype.privateExtendedKey=function(){if(!this._hdkey._privateKey)throw new Error("Private key is not available");return this._hdkey.privateExtendedKey},EthereumHDKey.prototype.publicExtendedKey=function(){return this._hdkey.publicExtendedKey},EthereumHDKey.prototype.derivePath=function(e){return fromHDKey(this._hdkey.derive(e))},EthereumHDKey.prototype.deriveChild=function(e){return fromHDKey(this._hdkey.deriveChild(e))},EthereumHDKey.prototype.getWallet=function(){return this._hdkey._privateKey?Wallet.fromPrivateKey(this._hdkey._privateKey):Wallet.fromPublicKey(this._hdkey._publicKey,!0)},module.exports=EthereumHDKey;

},{"./index.js":98,"hdkey":115}],98:[function(require,module,exports){
(function (Buffer){
function assert(e,t){if(!e)throw new Error(t||"Assertion failed")}function decipherBuffer(e,t){return Buffer.concat([e.update(t),e.final()])}var ethUtil=require("ethereumjs-util"),crypto=require("crypto"),scryptsy=require("scrypt.js"),uuid=require("uuid"),bs58check=require("bs58check"),Wallet=function(e,t){if(e&&t)throw new Error("Cannot supply both a private and a public key to the constructor");if(e&&!ethUtil.isValidPrivate(e))throw new Error("Private key does not satisfy the curve requirements (ie. it is invalid)");if(t&&!ethUtil.isValidPublic(t))throw new Error("Invalid public key");this._privKey=e,this._pubKey=t};Object.defineProperty(Wallet.prototype,"privKey",{get:function(){return assert(this._privKey,"This is a public key only wallet"),this._privKey}}),Object.defineProperty(Wallet.prototype,"pubKey",{get:function(){return this._pubKey||(this._pubKey=ethUtil.privateToPublic(this.privKey)),this._pubKey}}),Wallet.generate=function(e){if(!e)return new Wallet(crypto.randomBytes(32));for(;;){var t=crypto.randomBytes(32);if(0===ethUtil.privateToAddress(t)[0])return new Wallet(t)}},Wallet.prototype.getPrivateKey=function(){return this.privKey},Wallet.prototype.getPrivateKeyString=function(){return ethUtil.bufferToHex(this.getPrivateKey())},Wallet.prototype.getPublicKey=function(){return this.pubKey},Wallet.prototype.getPublicKeyString=function(){return ethUtil.bufferToHex(this.getPublicKey())},Wallet.prototype.getAddress=function(){return ethUtil.publicToAddress(this.pubKey)},Wallet.prototype.getAddressString=function(){return ethUtil.bufferToHex(this.getAddress())},Wallet.prototype.getChecksumAddressString=function(){return ethUtil.toChecksumAddress(this.getAddressString())},Wallet.prototype.toV3=function(e,t){assert(this._privKey,"This is a public key only wallet");var r,i=(t=t||{}).salt||crypto.randomBytes(32),o=t.iv||crypto.randomBytes(16),n=t.kdf||"scrypt",s={dklen:t.dklen||32,salt:i.toString("hex")};if("pbkdf2"===n)s.c=t.c||262144,s.prf="hmac-sha256",r=crypto.pbkdf2Sync(new Buffer(e),i,s.c,s.dklen,"sha256");else{if("scrypt"!==n)throw new Error("Unsupported kdf");s.n=t.n||262144,s.r=t.r||8,s.p=t.p||1,r=scryptsy(new Buffer(e),i,s.n,s.r,s.p,s.dklen)}var a=crypto.createCipheriv(t.cipher||"aes-128-ctr",r.slice(0,16),o);if(!a)throw new Error("Unsupported cipher");var p=Buffer.concat([a.update(this.privKey),a.final()]),c=ethUtil.sha3(Buffer.concat([r.slice(16,32),new Buffer(p,"hex")]));return{version:3,id:uuid.v4({random:t.uuid||crypto.randomBytes(16)}),address:this.getAddress().toString("hex"),crypto:{ciphertext:p.toString("hex"),cipherparams:{iv:o.toString("hex")},cipher:t.cipher||"aes-128-ctr",kdf:n,kdfparams:s,mac:c.toString("hex")}}},Wallet.prototype.getV3Filename=function(e){return["UTC--",(e?new Date(e):new Date).toJSON().replace(/:/g,"-"),"--",this.getAddress().toString("hex")].join("")},Wallet.prototype.toV3String=function(e,t){return JSON.stringify(this.toV3(e,t))},Wallet.fromPublicKey=function(e,t){return t&&(e=ethUtil.importPublic(e)),new Wallet(null,e)},Wallet.fromExtendedPublicKey=function(e){return assert("xpub"===e.slice(0,4),"Not an extended public key"),e=bs58check.decode(e).slice(45),Wallet.fromPublicKey(e,!0)},Wallet.fromPrivateKey=function(e){return new Wallet(e)},Wallet.fromExtendedPrivateKey=function(e){assert("xprv"===e.slice(0,4),"Not an extended private key");var t=bs58check.decode(e);return assert(0===t[45],"Invalid extended private key"),Wallet.fromPrivateKey(t.slice(46))},Wallet.fromV1=function(e,t){assert("string"==typeof t);var r="object"==typeof e?e:JSON.parse(e);if("1"!==r.Version)throw new Error("Not a V1 wallet");if("scrypt"!==r.Crypto.KeyHeader.Kdf)throw new Error("Unsupported key derivation scheme");var i=r.Crypto.KeyHeader.KdfParams,o=scryptsy(new Buffer(t),new Buffer(r.Crypto.Salt,"hex"),i.N,i.R,i.P,i.DkLen),n=new Buffer(r.Crypto.CipherText,"hex");if(ethUtil.sha3(Buffer.concat([o.slice(16,32),n])).toString("hex")!==r.Crypto.MAC)throw new Error("Key derivation failed - possibly wrong passphrase");var s=decipherBuffer(crypto.createDecipheriv("aes-128-cbc",ethUtil.sha3(o.slice(0,16)).slice(0,16),new Buffer(r.Crypto.IV,"hex")),n);return new Wallet(s)},Wallet.fromV3=function(e,t,r){assert("string"==typeof t);var i="object"==typeof e?e:JSON.parse(r?e.toLowerCase():e);if(3!==i.version)throw new Error("Not a V3 wallet");var o,n;if("scrypt"===i.crypto.kdf)n=i.crypto.kdfparams,o=scryptsy(new Buffer(t),new Buffer(n.salt,"hex"),n.n,n.r,n.p,n.dklen);else{if("pbkdf2"!==i.crypto.kdf)throw new Error("Unsupported key derivation scheme");if("hmac-sha256"!==(n=i.crypto.kdfparams).prf)throw new Error("Unsupported parameters to PBKDF2");o=crypto.pbkdf2Sync(new Buffer(t),new Buffer(n.salt,"hex"),n.c,n.dklen,"sha256")}var s=new Buffer(i.crypto.ciphertext,"hex");if(ethUtil.sha3(Buffer.concat([o.slice(16,32),s])).toString("hex")!==i.crypto.mac)throw new Error("Key derivation failed - possibly wrong passphrase");var a=decipherBuffer(crypto.createDecipheriv(i.crypto.cipher,o.slice(0,16),new Buffer(i.crypto.cipherparams.iv,"hex")),s,"hex");return new Wallet(a)},Wallet.fromEthSale=function(e,t){assert("string"==typeof t);var r="object"==typeof e?e:JSON.parse(e),i=new Buffer(r.encseed,"hex"),o=crypto.pbkdf2Sync(t,t,2e3,32,"sha256").slice(0,16),n=decipherBuffer(crypto.createDecipheriv("aes-128-cbc",o,i.slice(0,16)),i.slice(16)),s=new Wallet(ethUtil.sha3(n));if(s.getAddress().toString("hex")!==r.ethaddr)throw new Error("Decoded key mismatch - possibly wrong passphrase");return s},module.exports=Wallet;

}).call(this,require("buffer").Buffer)
},{"bs58check":51,"buffer":53,"crypto":65,"ethereumjs-util":96,"scrypt.js":171,"uuid":195}],99:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":53,"is-hex-prefixed":121,"strip-hex-prefix":189}],100:[function(require,module,exports){
...
},{"md5.js":131,"safe-buffer":170}],102:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":53,"inherits":119,"stream":187}],103:[function(require,module,exports){
...
},{"./utils":114,"minimalistic-assert":134}],105:[function(require,module,exports){
...
},{"./utils":114,"minimalistic-assert":134}],106:[function(require,module,exports){
...
},{"../common":104,"../utils":114,"./common":113,"minimalistic-assert":134}],111:[function(require,module,exports){
...
},{"../common":104,"../utils":114,"minimalistic-assert":134}],113:[function(require,module,exports){
...
},{"inherits":119,"minimalistic-assert":134}],115:[function(require,module,exports){
(function (Buffer){
function HDKey(e){this.versions=e||BITCOIN_VERSIONS,this.depth=0,this.index=0,this._privateKey=null,this._publicKey=null,this.chainCode=null,this._fingerprint=0,this.parentFingerprint=0}function serialize(e,t,i){var r=new Buffer(LEN);r.writeUInt32BE(t,0),r.writeUInt8(e.depth,4);var n=e.depth?e.parentFingerprint:0;return r.writeUInt32BE(n,5),r.writeUInt32BE(e.index,9),e.chainCode.copy(r,13),i.copy(r,45),r}function hash160(e){var t=crypto.createHash("sha256").update(e).digest();return crypto.createHash("rmd160").update(t).digest()}var assert=require("assert"),crypto=require("crypto"),cs=require("coinstring"),secp256k1=require("secp256k1"),MASTER_SECRET=new Buffer("Bitcoin seed"),HARDENED_OFFSET=2147483648,LEN=78,BITCOIN_VERSIONS={private:76066276,public:76067358};Object.defineProperty(HDKey.prototype,"fingerprint",{get:function(){return this._fingerprint}}),Object.defineProperty(HDKey.prototype,"identifier",{get:function(){return this._identifier}}),Object.defineProperty(HDKey.prototype,"pubKeyHash",{get:function(){return this.identifier}}),Object.defineProperty(HDKey.prototype,"privateKey",{get:function(){return this._privateKey},set:function(e){assert.equal(e.length,32,"Private key must be 32 bytes."),assert(!0===secp256k1.privateKeyVerify(e),"Invalid private key"),this._privateKey=e,this._publicKey=secp256k1.publicKeyCreate(e,!0),this._identifier=hash160(this.publicKey),this._fingerprint=this._identifier.slice(0,4).readUInt32BE(0)}}),Object.defineProperty(HDKey.prototype,"publicKey",{get:function(){return this._publicKey},set:function(e){assert(33===e.length||65===e.length,"Public key must be 33 or 65 bytes."),assert(!0===secp256k1.publicKeyVerify(e),"Invalid public key"),this._publicKey=secp256k1.publicKeyConvert(e,!0),this._identifier=hash160(this.publicKey),this._fingerprint=this._identifier.slice(0,4).readUInt32BE(0),this._privateKey=null}}),Object.defineProperty(HDKey.prototype,"privateExtendedKey",{get:function(){return this._privateKey?cs.encode(serialize(this,this.versions.private,Buffer.concat([new Buffer([0]),this.privateKey]))):null}}),Object.defineProperty(HDKey.prototype,"publicExtendedKey",{get:function(){return cs.encode(serialize(this,this.versions.public,this.publicKey))}}),HDKey.prototype.derive=function(e){if("m"===e||"M"===e||"m'"===e||"M'"===e)return this;var t=this;return e.split("/").forEach(function(e,i){if(0!==i){var r=e.length>1&&"'"===e[e.length-1],n=parseInt(e,10);assert(n<HARDENED_OFFSET,"Invalid index"),r&&(n+=HARDENED_OFFSET),t=t.deriveChild(n)}else assert(e,"m","Invalid path")}),t},HDKey.prototype.deriveChild=function(e){var t=e>=HARDENED_OFFSET,i=new Buffer(4);i.writeUInt32BE(e,0);var r;if(t){assert(this.privateKey,"Could not derive hardened child key");var n=this.privateKey,s=new Buffer([0]);n=Buffer.concat([s,n]),r=Buffer.concat([n,i])}else r=Buffer.concat([this.publicKey,i]);var p=crypto.createHmac("sha512",this.chainCode).update(r).digest(),c=p.slice(0,32),a=p.slice(32),o=new HDKey(this.versions);if(this.privateKey)try{o.privateKey=secp256k1.privateKeyTweakAdd(this.privateKey,c)}catch(t){return this.derive(e+1)}else try{o.publicKey=secp256k1.publicKeyTweakAdd(this.publicKey,c,!0)}catch(i){return this.derive(e+1,t)}return o.chainCode=a,o.depth=this.depth+1,o.parentFingerprint=this.fingerprint,o.index=e,o},HDKey.prototype.toJSON=function(){return{xpriv:this.privateExtendedKey,xpub:this.publicExtendedKey}},HDKey.fromMasterSeed=function(e,t){var i=crypto.createHmac("sha512",MASTER_SECRET).update(e).digest(),r=i.slice(0,32),n=i.slice(32),s=new HDKey(t);return s.chainCode=n,s.privateKey=r,s},HDKey.fromExtendedKey=function(e,t){var i=new HDKey(t=t||BITCOIN_VERSIONS),r=cs.decode(e),n=r.readUInt32BE(0);assert(n===t.private||n===t.public,"Version mismatch: does not match private or public"),i.depth=r.readUInt8(4),i.parentFingerprint=r.readUInt32BE(5),i.index=r.readUInt32BE(9),i.chainCode=r.slice(13,45);var s=r.slice(45);return 0===s.readUInt8(0)?(assert(n===t.private,"Version mismatch: version does not match private"),i.privateKey=s.slice(1)):(assert(n===t.public,"Version mismatch: version does not match public"),i.publicKey=s),i},HDKey.fromJSON=function(e){return HDKey.fromExtendedKey(e.xpriv)},HDKey.HARDENED_OFFSET=HARDENED_OFFSET,module.exports=HDKey;

}).call(this,require("buffer").Buffer)
},{"assert":15,"buffer":53,"coinstring":55,"crypto":65,"secp256k1":173}],116:[function(require,module,exports){
...
},{"hash.js":103,"minimalistic-assert":134,"minimalistic-crypto-utils":135}],117:[function(require,module,exports){
...
},{"inherits":119,"safe-buffer":170,"stream":187}],127:[function(require,module,exports){
...
},{"inherits":119,"safe-buffer":170,"stream":187}],128:[function(require,module,exports){
...
},{"./keccak-state-unroll":128,"safe-buffer":170}],130:[function(require,module,exports){
module.exports=require("browserify-sha3").SHA3Hash;

},{"browserify-sha3":43}],131:[function(require,module,exports){
(function (Buffer){
...
},{"buffer":53,"hash-base":132,"inherits":119}],132:[function(require,module,exports){
...
},{"inherits":119,"safe-buffer":170,"stream":187}],133:[function(require,module,exports){
...
},{"bn.js":19,"brorand":20}],134:[function(require,module,exports){
...
},{"./certificate":138,"asn1.js":1}],138:[function(require,module,exports){
...
},{"asn1.js":1}],139:[function(require,module,exports){
(function (Buffer){
...
},{"browserify-aes":24,"buffer":53,"evp_bytestokey":101}],140:[function(require,module,exports){
(function (Buffer){
...
},{"./aesid.json":136,"./asn1":137,"./fixProc":139,"browserify-aes":24,"buffer":53,"pbkdf2":141}],141:[function(require,module,exports){
...
},{"./default-encoding":143,"./precondition":144,"./sync":145,"_process":147,"safe-buffer":170}],143:[function(require,module,exports){
(function (process){
...
},{"./default-encoding":143,"./precondition":144,"create-hash/md5":62,"ripemd160":168,"safe-buffer":170,"sha.js":180}],146:[function(require,module,exports){
(function (process){
...
},{"buffer":53,"create-hash":60}],150:[function(require,module,exports){
(function (Buffer){
...
},{"./mgf":149,"./withPublic":152,"./xor":153,"bn.js":19,"browserify-rsa":42,"buffer":53,"create-hash":60,"parse-asn1":140}],151:[function(require,module,exports){
(function (Buffer){
...
},{"./mgf":149,"./withPublic":152,"./xor":153,"bn.js":19,"browserify-rsa":42,"buffer":53,"create-hash":60,"parse-asn1":140,"randombytes":154}],152:[function(require,module,exports){
(function (Buffer){
...
},{"bn.js":19,"buffer":53}],153:[function(require,module,exports){
...
},{"_process":147,"safe-buffer":170}],155:[function(require,module,exports){
...
},{"./_stream_readable":158,"./_stream_writable":160,"core-util-is":58,"inherits":119,"process-nextick-args":146}],157:[function(require,module,exports){
...
},{"./_stream_transform":159,"core-util-is":58,"inherits":119}],158:[function(require,module,exports){
(function (process,global){
...
},{"./_stream_duplex":156,"./internal/streams/BufferList":161,"./internal/streams/destroy":162,"./internal/streams/stream":163,"_process":147,"core-util-is":58,"events":100,"inherits":119,"isarray":122,"process-nextick-args":146,"safe-buffer":170,"string_decoder/":188,"util":21}],159:[function(require,module,exports){
...
},{"./_stream_duplex":156,"core-util-is":58,"inherits":119}],160:[function(require,module,exports){
(function (process,global){
...
},{"./_stream_duplex":156,"./internal/streams/destroy":162,"./internal/streams/stream":163,"_process":147,"core-util-is":58,"inherits":119,"process-nextick-args":146,"safe-buffer":170,"util-deprecate":190}],161:[function(require,module,exports){
...
},{"safe-buffer":170}],162:[function(require,module,exports){
...
},{"process-nextick-args":146}],163:[function(require,module,exports){
...
},{"buffer":53,"hash-base":102,"inherits":119}],169:[function(require,module,exports){
(function (Buffer){
...
},{"assert":15,"buffer":53}],170:[function(require,module,exports){
...
},{"buffer":53}],171:[function(require,module,exports){
module.exports=require("scryptsy");

},{"scryptsy":172}],172:[function(require,module,exports){
(function (Buffer){
function scrypt(r,f,o,a,e,n,t){function c(r,f,o,a){var e;for(arraycopy(r,f+64*(2*a-1),A,0,64),e=0;e<2*a;e++)p(r,64*e,A,0,64),u(A),arraycopy(A,0,r,o+64*e,64);for(e=0;e<a;e++)arraycopy(r,o+2*e*64,r,f+64*e,64);for(e=0;e<a;e++)arraycopy(r,o+64*(2*e+1),r,f+64*(e+a),64)}function y(r,f){return r<<f|r>>>32-f}function u(r){var f;for(f=0;f<16;f++)w[f]=(255&r[4*f+0])<<0,w[f]|=(255&r[4*f+1])<<8,w[f]|=(255&r[4*f+2])<<16,w[f]|=(255&r[4*f+3])<<24;for(arraycopy(w,0,d,0,16),f=8;f>0;f-=2)d[4]^=y(d[0]+d[12],7),d[8]^=y(d[4]+d[0],9),d[12]^=y(d[8]+d[4],13),d[0]^=y(d[12]+d[8],18),d[9]^=y(d[5]+d[1],7),d[13]^=y(d[9]+d[5],9),d[1]^=y(d[13]+d[9],13),d[5]^=y(d[1]+d[13],18),d[14]^=y(d[10]+d[6],7),d[2]^=y(d[14]+d[10],9),d[6]^=y(d[2]+d[14],13),d[10]^=y(d[6]+d[2],18),d[3]^=y(d[15]+d[11],7),d[7]^=y(d[3]+d[15],9),d[11]^=y(d[7]+d[3],13),d[15]^=y(d[11]+d[7],18),d[1]^=y(d[0]+d[3],7),d[2]^=y(d[1]+d[0],9),d[3]^=y(d[2]+d[1],13),d[0]^=y(d[3]+d[2],18),d[6]^=y(d[5]+d[4],7),d[7]^=y(d[6]+d[5],9),d[4]^=y(d[7]+d[6],13),d[5]^=y(d[4]+d[7],18),d[11]^=y(d[10]+d[9],7),d[8]^=y(d[11]+d[10],9),d[9]^=y(d[8]+d[11],13),d[10]^=y(d[9]+d[8],18),d[12]^=y(d[15]+d[14],7),d[13]^=y(d[12]+d[15],9),d[14]^=y(d[13]+d[12],13),d[15]^=y(d[14]+d[13],18);for(f=0;f<16;++f)w[f]=d[f]+w[f];for(f=0;f<16;f++){var o=4*f;r[o+0]=w[f]>>0&255,r[o+1]=w[f]>>8&255,r[o+2]=w[f]>>16&255,r[o+3]=w[f]>>24&255}}function p(r,f,o,a,e){for(var n=0;n<e;n++)o[a+n]^=r[f+n]}if(0===o||0!=(o&o-1))throw Error("N must be > 0 and a power of 2");if(o>MAX_VALUE/128/a)throw Error("Parameter N is too large");if(a>MAX_VALUE/128/e)throw Error("Parameter r is too large");var i,s=new Buffer(256*a),v=new Buffer(128*a*o),w=new Int32Array(16),d=new Int32Array(16),A=new Buffer(64),B=pbkdf2Sync(r,f,1,128*e*a,"sha256");if(t){var E=e*o*2,b=0;i=function(){++b%1e3==0&&t({current:b,total:E,percent:b/E*100})}}for(var h=0;h<e;h++)!function(r,f,o,a,e,n){var t,y=128*o;for(r.copy(n,0,f,f+y),t=0;t<a;t++)n.copy(e,t*y,0,0+y),c(n,0,y,o),i&&i();for(t=0;t<a;t++){var u=0+64*(2*o-1);p(e,(n.readUInt32LE(u)&a-1)*y,n,0,y),c(n,0,y,o),i&&i()}n.copy(r,f,0,0+y)}(B,128*h*a,a,o,v,s);return pbkdf2Sync(r,B,1,n,"sha256")}function arraycopy(r,f,o,a,e){if(Buffer.isBuffer(r)&&Buffer.isBuffer(o))r.copy(o,a,f,f+e);else for(;e--;)o[a++]=r[f++]}var pbkdf2Sync=require("pbkdf2").pbkdf2Sync,MAX_VALUE=2147483647;module.exports=scrypt;

}).call(this,require("buffer").Buffer)
},{"buffer":53,"pbkdf2":141}],173:[function(require,module,exports){
...
},{"../../is-buffer/index.js":120}],175:[function(require,module,exports){
...
},{"bip66":18,"safe-buffer":170}],176:[function(require,module,exports){
...
},{"../messages.json":178,"bn.js":19,"create-hash":60,"elliptic":76,"safe-buffer":170}],177:[function(require,module,exports){
...
},{"safe-buffer":170}],180:[function(require,module,exports){
...
},{"./hash":179,"inherits":119,"safe-buffer":170}],182:[function(require,module,exports){
...
},{"./hash":179,"inherits":119,"safe-buffer":170}],183:[function(require,module,exports){
...
},{"./hash":179,"./sha256":184,"inherits":119,"safe-buffer":170}],184:[function(require,module,exports){
...
},{"./hash":179,"inherits":119,"safe-buffer":170}],185:[function(require,module,exports){
...
},{"./hash":179,"./sha512":186,"inherits":119,"safe-buffer":170}],186:[function(require,module,exports){
...
},{"./hash":179,"inherits":119,"safe-buffer":170}],187:[function(require,module,exports){
...
},{"events":100,"inherits":119,"readable-stream/duplex.js":155,"readable-stream/passthrough.js":164,"readable-stream/readable.js":165,"readable-stream/transform.js":166,"readable-stream/writable.js":167}],188:[function(require,module,exports){
...
function parse(e,s,r){var t=s&&r||0,n=0;for(s=s||[],e.toLowerCase().replace(/[0-9a-f]{2}/g,function(e){n<16&&(s[t+n++]=_hexToByte[e])});n<16;)s[t+n++]=0;return s}function unparse(e,s){var r=s||0,t=_byteToHex;return t[e[r++]]+t[e[r++]]+t[e[r++]]+t[e[r++]]+"-"+t[e[r++]]+t[e[r++]]+"-"+t[e[r++]]+t[e[r++]]+"-"+t[e[r++]]+t[e[r++]]+"-"+t[e[r++]]+t[e[r++]]+t[e[r++]]+t[e[r++]]+t[e[r++]]+t[e[r++]]}function v1(e,s,r){var t=s&&r||0,n=s||[],o=void 0!==(e=e||{}).clockseq?e.clockseq:_clockseq,a=void 0!==e.msecs?e.msecs:(new Date).getTime(),u=void 0!==e.nsecs?e.nsecs:_lastNSecs+1,c=a-_lastMSecs+(u-_lastNSecs)/1e4;if(c<0&&void 0===e.clockseq&&(o=o+1&16383),(c<0||a>_lastMSecs)&&void 0===e.nsecs&&(u=0),u>=1e4)throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");_lastMSecs=a,_lastNSecs=u,_clockseq=o;var i=(1e4*(268435455&(a+=122192928e5))+u)%4294967296;n[t++]=i>>>24&255,n[t++]=i>>>16&255,n[t++]=i>>>8&255,n[t++]=255&i;var _=a/4294967296*1e4&268435455;n[t++]=_>>>8&255,n[t++]=255&_,n[t++]=_>>>24&15|16,n[t++]=_>>>16&255,n[t++]=o>>>8|128,n[t++]=255&o;for(var d=e.node||_nodeId,v=0;v<6;v++)n[t+v]=d[v];return s||unparse(n)}function v4(e,s,r){var t=s&&r||0;"string"==typeof e&&(s="binary"==e?new Array(16):null,e=null);var n=(e=e||{}).random||(e.rng||_rng)();if(n[6]=15&n[6]|64,n[8]=63&n[8]|128,s)for(var o=0;o<16;o++)s[t+o]=n[o];return s||unparse(n)}for(var _rng=require("./rng"),_byteToHex=[],_hexToByte={},i=0;i<256;i++)_byteToHex[i]=(i+256).toString(16).substr(1),_hexToByte[_byteToHex[i]]=i;var _seedBytes=_rng(),_nodeId=[1|_seedBytes[0],_seedBytes[1],_seedBytes[2],_seedBytes[3],_seedBytes[4],_seedBytes[5]],_clockseq=16383&(_seedBytes[6]<<8|_seedBytes[7]),_lastMSecs=0,_lastNSecs=0,uuid=v4;uuid.v1=v1,uuid.v4=v4,uuid.parse=parse,uuid.unparse=unparse,module.exports=uuid;

},{"./rng":194}],196:[function(require,module,exports){
...
},{"indexof":118}],197:[function(require,module,exports){
"use strict";module.exports={Buffer:require("buffer"),BN:require("ethereumjs-util").BN,ICAP:require("ethereumjs-icap"),RLP:require("ethereumjs-util").rlp,Tx:require("ethereumjs-tx"),Util:require("ethereumjs-util"),Wallet:require("ethereumjs-wallet"),WalletHD:require("ethereumjs-wallet/hdkey")};

},{"buffer":53,"ethereumjs-icap":93,"ethereumjs-tx":94,"ethereumjs-util":96,"ethereumjs-wallet":98,"ethereumjs-wallet/hdkey":97}]},{},[197])(197)
});
